...
export default function Loader({ onFinish }: LoaderProps) {
	...
	return (
		<div
			ref={containerRef}
			className='fixed inset-0 z-50 justify-items-start items-end-safe flex w-full pb-16'
			...
			<div className='overflow-hidden w-fit'>
				<h1
					ref={textRef}
					className='font-podium text-[8vw] uppercase text-black leading-none select-none'
					style={{ opacity: 0 }}>
					Ronniel
				</h1>
			</div>
